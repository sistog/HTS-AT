...
exp_name = "exp_htsat_deepship" # the saved ckpt prefix name of the model 
workspace = "./workspace" # the folder of your code
dataset_path = "./workspace/deepship" # the dataset path
desed_folder = "" # the desed file

dataset_type = "deepship" # "audioset" "esc-50" "scv2"
...
# "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt"
...
# for data collection
classes_num = 4 # esc: 50 | audioset: 527 | scv2: 35
...
# "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/pretrain/swin_tiny_c24_patch4_window8_256.pth"
...
esm_model_pathes = [
    "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt",
    "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_2.ckpt",
    "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_3.ckpt",
    "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_4.ckpt",
    "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_5.ckpt",
    "/data/zcx/wav_prj/HTS-Audio-Transformer/model_backup/AudioSet/HTSAT_AudioSet_Saved_6.ckpt"
]

# for framewise localization
heatmap_dir = "/data/zcx/wav_prj/HTS-Audio-Transformer/heatmap_output"
test_file = "htsat-test-ensemble"
fl_local = False # indicate if we need to use this dataset for the framewise detection
fl_dataset = "/data/zcx/wav_prj/HTS-Audio-Transformer/desed/desed_eval.npy"  
fl_class_num = [
