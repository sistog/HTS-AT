...
workspace = "/data/zcx/wav_prj/HTS-Audio-Transformer/HTSAT" # the folder of your code
dataset_path = "/data/zcx/wav_prj/HTS-Audio-Transformeraudioset" # the dataset path
desed_folder = "/data/zcx/wav_prj/HTS-Audio-Transformer/DESED" # the desed file
